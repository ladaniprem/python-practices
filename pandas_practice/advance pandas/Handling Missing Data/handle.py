...
df.dropna(inplace=True)  # axis=0 means row and axis=1 means column
#inplace=True means changes will be applied to original dataframe
#implace meaning changes will be applied to original dataframe
